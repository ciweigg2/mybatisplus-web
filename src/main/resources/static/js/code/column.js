...
$UU.init({
    data: {
        ...
        columnForm:{
            ...
            mapperXmlPackage:'resources.mapper',
        ...
        queryTableStrategy: function(){
            ...
            $UU.http.get("/get-table-strategy",{id:_this.search_group.id,tableName:_this.search_group.tableName},function (response) {
                if(response.data.data != undefined) {
                    ...
                    _this.columnForm.projectPath = response.data.data.projectPath;
                    ...
                    _this.columnForm.mapperXmlPackage = response.data.data.mapperXmlPackage;
